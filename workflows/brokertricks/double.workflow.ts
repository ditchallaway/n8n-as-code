...
@workflow({
    ...
    active: true,
    description:
        "[ARCHIVED - replaced by render workflow] this workflow produces an overhead, north facing view as well as a static map with labels for the editor's  reference and the boundary kml file. the kml is widely accepted in map software and can be used to create the images as a fallback.",
    isArchived: false,
    settings: {
        executionOrder: 'v1',
...
https://brokertricks.com/wp-admin/admin.php?page=surecart-orders&id={{ $("Prepare Configuration").item.json.order_id }}`,
  ...
  "resumeUrl": $resumeUrl 
    ...
    @node({
        id: 'd0c8af75-6419-4bd5-af3e-7b2cd72f893d',
    ...
    @node({
        id: '34abf855-4088-43b4-958f-946dcdf976de',
        name: 'create a note',
        type: 'n8n-nodes-base.httpRequest',
        version: 4.3,
        position: [2896, 272],
...
`,
    ...
    @node({
        id: '498a6b60-9e10-46a3-beb0-4501076766e9',
        name: 'If',
    ...
    @node({
        id: 'a0f85399-574b-4df9-b585-007da909f860',
        name: 'HTTP Request1',
        type: 'n8n-nodes-base.httpRequest',
        version: 4.4,
        position: [2896, 464],
...
"Editor URL": {{JSON.stringify( $('Shorten Editor URL').item.json.shortLink) }}}
    ...
    @node({
        id: 'eec323a2-a59c-48bb-b980-0f82aa7deabd',
    ...
    @node({
        id: 'fc30d8d6-cc51-4760-b64e-ce9506948fc9',
        name: 'HTTP Request4',
        type: 'n8n-nodes-base.httpRequest',
        version: 4.4,
        position: [-1584, 368],
