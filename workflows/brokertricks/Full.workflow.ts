...
"Editor URL": {{JSON.stringify( $('Shorten Editor URL').item.json.shortLink) }}}
  ...
  "resumeUrl": $resumeUrl 
    ...
    @node({
        id: '3046223c-e36f-4db3-a70c-5bc0e8d4b7a5',
        name: 'Edit Fields4',
        type: 'n8n-nodes-base.set',
        version: 3.4,
        position: [-176, 368],
    ...
    @node({
        id: '1468ab8b-a4a0-44d0-9d28-07f1b432a475',
        name: 'Switch',
    ...
    @node({
        id: '707d90a6-00f7-4d3f-8825-ec2c77c523ca',
        name: 'Edit Fields5',
        type: 'n8n-nodes-base.set',
        version: 3.4,
        position: [-400, 560],
    ...
    @node({
        id: 'a0423d19-3063-4e1f-80e3-7e6f0c9eea37',
        name: 'Edit Fields6',
        type: 'n8n-nodes-base.set',
        version: 3.4,
        position: [-400, 368],
    ...
    @node({
        id: '4344e423-7613-4be9-a4f0-740135310e17',
        name: 'Edit Fields7',
        type: 'n8n-nodes-base.set',
        version: 3.4,
        position: [-400, 176],
