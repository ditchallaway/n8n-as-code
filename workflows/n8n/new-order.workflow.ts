...
// CallSingleWorkflow1                executeWorkflow
// CallDoubleworkflow                 executeWorkflow
//
// ROUTING MAP
// ──────────────────────────────────────────────────────────────────
// Webhook
...
return $input.all();`,
    ...
    CallSingleWorkflow1 = {
        workflowId: {
            ...
            mode: 'list',
            cachedResultUrl: '/workflow/fD94owK14KYr97yB',
    ...
    CallDoubleworkflow = {
        workflowId: {
            ...
            mode: 'list',
            cachedResultUrl: '/workflow/Tqh6g1yqvcfi5qeF',
    ...
    defineRouting() {
        ...
        this.Switch_.out(0).to(this.CallSingleWorkflow1.in(0));
        this.Switch_.out(1).to(this.CallDoubleworkflow.in(0));
        ...
        this.CallSingleWorkflow1.out(0).to(this.Wait.in(0));
        this.CallDoubleworkflow.out(0).to(this.Wait.in(0));
    }
}
